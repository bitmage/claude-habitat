...
# Use --no-tty to disable TTY allocation when running from script
./claude-habitat start claude-habitat --no-tty --cmd "claude --dangerously-skip-permissions -p '$prompt'"
